namespace WMI.Win32 {
    ...
    public class Win32Process : System.ComponentModel.Component {
        ...
        public Win32Process(string keyHandle) {
            this.InitializeObject(null, new System.Management.ManagementPath(Win32Process.ConstructPath(keyHandle)), null);
        }
        
        public Win32Process(System.Management.ManagementScope mgmtScope, string keyHandle) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(Win32Process.ConstructPath(keyHandle)), null);
        }
        
        public Win32Process(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public Win32Process(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public Win32Process(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public Win32Process(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public Win32Process(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public Win32Process(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        public class ProcessCollection : object, ICollection {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new Win32Process(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class ProcessEnumerator : object, System.Collections.IEnumerator {
                ...
                public virtual object Current {
                    get {
                        return new Win32Process(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
